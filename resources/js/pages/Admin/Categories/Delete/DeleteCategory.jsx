...
const DeleteCategory = () => {
  ...
  const { category, appURL, customErrors, passwordTries } = usePage().props
  ...
  const submitSoftDelete = () => {
    setTries(t => t + 1)
    Inertia.post(route('admin.cat.delete', category.id), {
      deleteType: 'soft',
      password: password,
  ...
  return (
    <AdminLayout>
      ...
      <Head title={ translate('delete-category') } />

      <AdminHeader title={ translate('delete-category') } icon={faEdit} />
