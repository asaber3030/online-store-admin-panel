  ...
  return (
    <AdminLayout>
      ...
      <div className="view-user-container">
        ...
        <UserNavigationMenu user={user} activePage='purchased-services' />

        <div className="page-user-content main-user-view">

          <UserPageHeader user={user} appURL={appURL} addTitle='Purchased Services - ' />

          <List
            columns={PurchasedServicesColumns}
            rows={user.purchased_services}
          />
